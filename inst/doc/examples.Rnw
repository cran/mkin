...
FOCUS_2006_Z = data.frame(
  ...
  Z = c(100, 81.7, 70.4, 51.1, 41.2, 6.6, 4.6, 3.9, 4.6, 4.3, 6.8, 2.9, 3.5,
             5.3, 4.4, 1.2, 0.7),
...
Z.2a <- mkinmod(Z = list(type = "SFO", to = "Z1"),
                Z1 = list(type = "SFO"))
Z.2a.ff <- mkinmod(Z = list(type = "SFO", to = "Z1"),
...
<<FOCUS_2006_Z_fits_2, echo=TRUE>>=
Z.2b <- mkinmod(Z = list(type = "SFO", to = "Z1", sink = FALSE),
                Z1 = list(type = "SFO"))
Z.2b.ff <- mkinmod(Z = list(type = "SFO", to = "Z1", sink = FALSE), # needs warning
                Z1 = list(type = "SFO"), use_of_ff = "max")
